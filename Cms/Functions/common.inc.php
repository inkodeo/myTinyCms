...
function saveTemplateNewItem($pPageType, $pValue, $pOwner) {
    ...
    switch ($pPageType) {
        case 'content':
            $node = $dom->getElementsByTagName("framesets");
            $node = $node->item(0);
            break;
        ...
        case 'token':
            $node = $dom->getElementsByTagName("tokens");
            $node = $node->item(0);
            break;

        case 'script':
            $node = $dom->getElementsByTagName("scripts");
            $node = $node->item(0);
            break;

        case 'style':
            $node = $dom->getElementsByTagName("styles");
            $node = $node->item(0);
            break;
    }
...
function getAttribute($node) {// >((dom)node) ((array)tab)>
    $tab = array();
